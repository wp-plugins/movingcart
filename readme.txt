...
무빙카트 플러그인 설치, https://admin.movingcart.kr 에서 판매자 회원가입, 판매자 코드 저장이 필요합니다.
...
4. https://admin.movingcart.kr 에서 판매자 회원가입 후 발급받은 판매자 코드(마이페이지에서 확인 가능)를 복사합니다. 
